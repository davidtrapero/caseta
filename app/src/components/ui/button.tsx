...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-br from-primary to-secondary text-primary-foreground border border-[hsl(var(--primary)/0.5)] shadow-[0_4px_14px_hsl(var(--primary)/0.32),inset_0_1px_0_rgba(255,255,255,0.18)] hover:shadow-[0_6px_18px_hsl(var(--primary)/0.45),inset_0_1px_0_rgba(255,255,255,0.22)] transition-shadow",
        destructive:
